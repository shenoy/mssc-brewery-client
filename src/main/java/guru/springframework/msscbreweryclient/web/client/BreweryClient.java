...
public class BreweryClient {
    ...
    public void updateBeer(UUID uiid, BeerDto beerDto){
        restTemplate.put(apihost+ BEER_PATH_V1 + uiid, beerDto);
    ...
    public void deleteCustomer(UUID uiid){
        restTemplate.delete(apihost + CUSTOMER_PATH_V1 + uiid );
    }
}
